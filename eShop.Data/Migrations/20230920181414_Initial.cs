    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("9d436756-3f1c-41f3-b59f-9b221bfd1083"), "928d0fed-ce2a-4d0b-bf05-b14be365ccf4", "Administrator role", "admin", "admin" });

            migrationBuilder.InsertData(
                table: "AppUsers",
                columns: new[] { "Id", "AccessFailedCount", "ConcurrencyStamp", "Dob", "Email", "EmailConfirmed", "FirstName", "LastName", "LockoutEnabled", "LockoutEnd", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "SecurityStamp", "TwoFactorEnabled", "UserName" },
                values: new object[] { new Guid("7af97aee-9a3f-4008-ac98-3ce383de2ec0"), 0, "035e63a7-5a76-4ac2-bb03-e4b660852785", new DateTime(1999, 12, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), "admin@gmail.com", true, "Ha", "Hoang", false, null, "admin@gmail.com", "admin", "AQAAAAEAACcQAAAAEPSqmNZwazR55QMGVlQ2p1mpwX2FhI4j5jJ+l8mDgxDmm8Hi9tseD5cRabZsdh5jOA==", null, false, "", false, "admin" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2023, 9, 21, 1, 14, 14, 520, DateTimeKind.Local).AddTicks(8178), 100000m, 200000m },
                    { 2, new DateTime(2023, 9, 21, 1, 14, 14, 521, DateTimeKind.Local).AddTicks(5650), 200000m, 300000m }
                });

            migrationBuilder.InsertData(
                table: "AppUserRoles",
                columns: new[] { "UserId", "RoleId" },
                values: new object[] { new Guid("7af97aee-9a3f-4008-ac98-3ce383de2ec0"), new Guid("9d436756-3f1c-41f3-b59f-9b221bfd1083") });
